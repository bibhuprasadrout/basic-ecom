    ...
    <footer className='footer sm:footer-vertical bg-neutral text-neutral-content items-center p-4'>
      ...
      <div className='footer sm:footer-horizontal footer-center bg-neutral text-neutral-content items-center p-1'>
        <nav className='grid grid-flow-col gap-7'>
          ...
          <Link to='refundPolicy' className='link link-hover'>
            Refund policy
          </Link>
          <Link to='team' className='link link-hover'>
            Team
          </Link>
          <Link to='termsOfService ' className='link link-hover'>
            Terms of service
          </Link>
        </nav>
      </div>
      <div className='footer sm:footer-horizontal footer-center bg-neutral text-neutral-content items-center pt-1 pb-7'>
        <aside className='grid-flow-col items-center'>
          <p>
